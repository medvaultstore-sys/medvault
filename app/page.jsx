...
const IMG = {
  ...
  goniometer: [
    R("three-piece medical goniometer set on white background: large transparent plastic protractor with 360 degree markings, two moveable arms, pivot screw — clinical physiotherapy instrument, sharp product photography studio lighting", 101),
  ...
  hammer: [
    R("Taylor percussion reflex hammer on white background: triangular black rubber head, chrome stainless steel handle 25cm — neurological examination tool, sharp studio product photography", 111),
  ...
  tuningfork: [
    R("128 Hz medical tuning fork on white background: aluminium alloy U-shaped fork with two parallel prongs, long cylindrical handle with '128 Hz' stamped on it — neurological diagnostic instrument, sharp studio photo", 121),
  ...
  tape: [
    R("medical measuring tape on white background: soft flexible fabric tape 150cm, coiled loop showing centimetre and inch markings on both sides — physiotherapy body measurement tool, studio product photo", 131),
  ...
  pentorch: [
    R("chrome LED medical pen torch on white background: slim cylindrical design, bright LED tip, pupil gauge millimetre scale printed on barrel, pocket clip — clinical examination penlight, studio product photography", 141),
  ...
  stethoscope: [
    R("dual head stethoscope on white background: black Y-shaped tubing, chest piece with diaphragm side and bell side, soft ear tips, spring headset — acoustic medical instrument, studio product photography", 151),
  ...
  sphygmo: [
    R("aneroid sphygmomanometer blood pressure monitor on white background: round gauge dial with mmHg scale 0-300, black inflatable arm cuff with velcro closure, rubber hand bulb pump with metal screw valve, rubber tubing — clinical BP instrument, studio product photography", 161),
  ...
  yogamat: [
    R("6mm thick yoga mat on white background: teal green non-slip textured surface, partially rolled showing thickness and cross-section — physiotherapy exercise rehabilitation mat, studio product photography", 171),
  ...
  dynamometer: [
    R("hand grip dynamometer on white background: ergonomic grip handle with adjustable width, digital LCD display showing force reading in kg, chrome finish — physiotherapy muscle strength assessment instrument, studio product photography", 191),
