...
const KITS = [
  {
    ...
    items: [
      { name: "BPL Dual-Sided Chestpiece Stethoscope", qty: 1, retail: 1049 },
      { name: "Universal Goniometer", qty: 1, retail: 250 },
      { name: "Half-Range Goniometer", qty: 1, retail: 150 },
      { name: "Finger Goniometer", qty: 1, retail: 100 },
      { name: "128 Hz Tuning Fork", qty: 1, retail: 200 },
  ...
  },
  {
    ...
    items: [
      { name: "Universal Goniometer", qty: 1, retail: 300 },
      { name: "Half Range Goniometer", qty: 1, retail: 200 },
      { name: "Finger Goniometer", qty: 1, retail: 150 },
      { name: "Reflex (Knee) Hammer", qty: 1, retail: 150 },
      { name: "128 Hz Tuning Fork", qty: 1, retail: 250 },
      { name: "Measuring Tape", qty: 1, retail: 100 },
      { name: "Clinical Assessment Sheet (FREE)", qty: 1, retail: 100 },
      { name: "Skin Marker (FREE)", qty: 1, retail: 50 },
    ],
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Measuring Tape", qty: 1, retail: 100 },
      { name: "Pen Torch", qty: 1, retail: 150 },
      { name: "Clinical Assessment Sheet", qty: 1, retail: 150 },
...
// ── Individual Items ───────────────────────────────────────────
const ITEMS = [
  { id:"i-1",  type:"item", name:"BPL Dual-Sided Chestpiece Stethoscope", tagline:"Acoustic medical instrument", price:1049, originalPrice:1299, badge:"MONITORING", images:IMG.stethoscope, desc:"A dual-head acoustic stethoscope with a diaphragm for high-frequency sounds and a bell for low-frequency sounds. Suitable for cardiac, pulmonary, and abdominal auscultation.", stock:55 },
  { id:"i-2",  type:"item", name:"Universal Goniometer", tagline:"Large joint ROM measurement", price:300, originalPrice:450, badge:"PHYSIO TOOL", images:IMG.goniometer, desc:"A large transparent goniometer for measuring joint range of motion (ROM) in major joints like the hip, knee, and shoulder.", stock:80 },
  { id:"i-3",  type:"item", name:"Half-Range Goniometer", tagline:"Medium joint ROM measurement", price:200, originalPrice:300, badge:"PHYSIO TOOL", images:IMG.goniometer, desc:"A standard 180-degree half-circle goniometer with two adjustable arms, perfect for elbow and ankle measurements.", stock:80 },
  { id:"i-4",  type:"item", name:"Finger Goniometer", tagline:"Small joint ROM measurement", price:150, originalPrice:250, badge:"PHYSIO TOOL", images:IMG.goniometer, desc:"A small 90-degree finger goniometer for precision measurement of small joint ranges of motion.", stock:80 },
  { id:"i-5",  type:"item", name:"128 Hz Tuning Fork", tagline:"Vibration & hearing tests", price:250, originalPrice:320, badge:"NEURO TOOL", images:IMG.tuningfork, desc:"A 128 Hz aluminium alloy tuning fork used for assessing vibration sense and conducting Rinne and Weber tests.", stock:60 },
  { id:"i-6",  type:"item", name:"Reflex (Knee) Hammer", tagline:"Deep tendon reflex testing", price:150, originalPrice:220, badge:"NEURO TOOL", images:IMG.hammer, desc:"The Taylor percussion hammer is the standard tool for testing deep tendon reflexes in neurological and physiotherapy assessments.", stock:95 },
  ...
  { id:"i-13", type:"item", name:"Pen Torch", tagline:"Pupillary reflex testing", price:150, originalPrice:250, badge:"NEURO TOOL", images:IMG.pentorch, desc:"A chrome LED medical pen torch with bright LED tip and pupil gauge millimetre scale on the barrel.", stock:100 },
