...
const PRODUCTS = [
  {
    id: 1,
    name: "MedVault Physiotherapy Kit — Complete",
    tagline: "Everything a physio student needs",
    price: 1999,
    originalPrice: 2599,
    badge: "LAUNCH OFFER",
    color: C.primary,
    desc: "Our complete physiotherapy kit curated for BPT students at SRM campus. Includes all 10 essential instruments and supplies — from goniometer to resistance band — in one ready-to-use bundle.",
    features: ["Goniometer Set (3-in-1)","Knee Hammer","Tuning Fork","Inch Tape","Pen Torch","Stethoscope","Yoga Mat","Resistance Band","Vaseline","Physio Notes"],
    instruments: ["Joint measurement","Reflex testing","Vibration sense","Auscultation","Rehabilitation","Pupil exam"],
    stock: 48,
    img: "🏥",
  },
  {
    id: 2,
    name: "MedVault Physio Exam Kit",
    tagline: "Core tools for clinical exams",
    price: 699,
    originalPrice: 899,
    badge: "EXAM READY",
    color: C.accent,
    desc: "A focused 5-piece kit covering the essentials for physiotherapy practical exams — goniometer, knee hammer, tuning fork, inch tape, and pen torch.",
    features: ["Goniometer","Knee Hammer","Tuning Fork","Inch Tape","Pen Torch"],
    instruments: ["Joint measurement","Reflex testing","Vibration sense","Pupil exam","Body measurement"],
    stock: 72,
    img: "🩺",
  },
  {
    id: 3,
    name: "MedVault Physio Refill Kit",
    tagline: "Consumables & rehab top-up",
    price: 349,
    originalPrice: 449,
    badge: "REFILL",
    color: "#5BE6A8",
    desc: "Refill pack for your physio kit. Includes a resistance band, Vaseline, and medical tape — the consumables you'll need to replace first.",
    features: ["Resistance Band","Vaseline","Medical Tape"],
    instruments: ["Strength training","Skin care","Consumables"],
    stock: 100,
    img: "♻️",
  },
];
      ...
      <div className="hero-row" style={{ maxWidth: 1200, margin: "0 auto", width: "100%" }}>
        ...
        <div className="hero-text" style={{ flex: "0 0 auto", maxWidth: 560, animation: "fadeUp 0.8s ease both" }}>
          ...
          <p style={{
            ...
            Curated physiotherapy kits for BPT students at SRM campus — everything you need for practical labs, clinical exams, and rehab sessions.
          </p>
  ...
  return (
    <div>
      ...
      <div style={{
        ...
        {[["🚚", "Campus Delivery"], ["🦴", "Physio-Grade Quality"], ["📦", "SRM Campus Ready"], ["💬", "Order via WhatsApp"]].map(([icon, label]) => (
